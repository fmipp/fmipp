...
/*
void printModelState( ModelState state ){
	switch (state){
	case modelStartAndEnd:
		printf( "StartAndEnd" );
	case modelInstantiated:
		printf( "Instantiated" );
	case modelInitializationMode:
		printf( "InitializationMode" );
			// ME states
	case modelEventMode:
		printf( "EventMode" );
	case modelContinuousTimeMode:
		printf( "ContinuousTimeMode" );
			// CS states
	case modelStepComplete:
		printf( "StepComplete" );
	case modelStepInProgress:
		printf( "StepInProgress" );
	case modelStepFailed:
		printf( "StepFailed" );
	case modelStepCanceled:
		printf( "StepCanceled" );
