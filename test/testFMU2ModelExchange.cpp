...
BOOST_AUTO_TEST_CASE( test_model_manager_me )
{
	...
	std::shared_ptr<BareFMU2> bareFMU1 = manager.getInstance( fmuUrl, modelName, fmiTrue );
	std::shared_ptr<BareFMU2> bareFMU2 = manager.getInstance( fmuUrl, modelName, fmiTrue );
